...
endpoint_type_in_module = AUDIO_DEVICE_OUT_DGTL_DOCK_HEADSET
...
# usb headphone's behavior is same as 3.5mm headphone's in current DAX3.5 release
# these cases copied from 3.5mm headphone's cases
