...
def test_log_mi_on_2ch_verify(content_name, content_type, dap_status, dap_profile, dap_feature_type, dap_feature_value):
    ...
    Test Check Point:   for 2 channel dolby content , msce, mdee, miee, mdle, mave values are equal to 1
                        meanwhile volume level can't be turned off ig dvle = 1 in qmf process
    """
...
def test_log_up_mix_sv_off_verify_landscape(content_name, content_type,
    ...
    up_mix_and_sv_off_test_procedure(caller_name, endpoint_type_in_module,
...
def test_log_up_mix_sv_off_verify_portrait(content_name, content_type,
    ...
    caller_name = test_log_up_mix_sv_off_verify_portrait.__name__ + '_portrait_'
    up_mix_and_sv_off_test_procedure(caller_name, endpoint_type_in_module,
                                     content_name, content_type,
